...
class GaussianEditor(BaseLift3DSystem):
    ...
    def forward(
        self, batch: Dict[str, Any], renderbackground=None, local=False
    ) -> Dict[str, Any]:
    ...
    def configure_optimizers(self):
        ...
        opt = OptimizationParams(
            ...
            self.cfg.gs_lr_scaler,
            self.cfg.gs_final_lr_scaler,
            self.cfg.color_lr_scaler,
            self.cfg.opacity_lr_scaler,
            self.cfg.scaling_lr_scaler,
            self.cfg.rotation_lr_scaler,
        )
